...
import { FaFileExcel, FaSearch, FaFilter, FaTimes, FaEye, FaPhone, FaSchool, FaCalendar, FaMapMarkerAlt } from 'react-icons/fa';

const NationalApplicationsPage = () => {
  ...
  const loadApplications = async () => {
    try {
      setLoading(true);
      const data = await nationalApplicationService.getAllApplications();
  ...
  const applyFilters = () => {
    ...
    // Province filter
    if (filters.province) {
      filtered = filtered.filter(app => app.province === filters.province);
    }
  ...
  const exportToExcel = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Türkiye Geneli Başvurular');
    
    const excelBuffer = XLSX.write(wb, { bookType: 'xlsx', type: 'array' });
    const data = new Blob([excelBuffer], { type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' });
    
    const fileName = `turkiye_basvurular_${new Date().toISOString().split('T')[0]}.xlsx`;
  ...
  const uniqueDistricts = filters.province 
    ? applications.filter(app => app.province === filters.province).map(app => app.district)
    : getUniqueValues('district');
  const uniqueDistrictsFiltered = [...new Set(uniqueDistricts)].sort();
    ...
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <div className="mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2 flex items-center gap-2">
          ...
          Türkiye Geneli Başvuru Yönetimi
        </h1>
      ...
      <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          ...
          <div>
            ...
            >
              <option value="">Tümü</option>
              {uniqueDistrictsFiltered.map(district => (
          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">İl/İlçe</th>
                  ...
                  <tr key={app.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          <div className="text-sm font-medium text-gray-900">{app.province}</div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900">{selectedApplication.province}</p>
                  </div>
                  <div>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="space-y-2">
                  {selectedApplication.categories?.split(', ').map((cat, index) => (
...
export default NationalApplicationsPage;